...
Whatsapp Chat trasnlator translates chat messages with your contacts into different languages.
...
Register a new number and get its credentials. See https://github.com/mgp25/Chat-API/wiki/WhatsAPI-Documentation#number-registration
Update WAcredentials.php file with your whatsApp credentials.

Sign up and register for Microsoft Translator API. See https://www.microsoft.com/en-us/translator/getstarted.aspx
Update MScredentials.php file

Run waTranslateApp.php

Send a vCard of your contact or "Chat number" to start a new chat.
